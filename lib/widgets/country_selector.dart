...
class SelectButton extends StatelessWidget {
  ...
  //SelectButton({@required this.countries, @required this.country});
  SelectButton({List<String> countries, String country, this.onChanged}) {
    this.countries = CountryProvider.getCountriesData(countries: countries);
    this.country = getInitialSelectedCountry(this.countries, country);
  }
